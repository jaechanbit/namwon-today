...
export type WebAiSummary = { summary: string; key_points: string[]; model: string; updated_at: string };
export type WebArticle = {
  ...
  body_missing: boolean; source: WebSource; attachments: WebAttachment[]; ai_summary: WebAiSummary | null;
};
